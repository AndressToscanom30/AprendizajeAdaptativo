                            ...
                            <div className="w-full lg:w-1/2 flex justify-center p-4 mt-8 lg:mt-0">
                                <div className="relative w-full max-w-[250px] sm:max-w-[300px] md:max-w-[400px] lg:max-w-lg">
                                    ...
                                    <img
                                        ...
                                        alt="Robot Asistente"
                                        className="relative w-full object-contain transition-all duration-700 hover:scale-105 drop-shadow-xl"
                                        style={{
                                            transform: `translate(${mousePosition.x * 10}px, ${mousePosition.y * 10}px)`
                                        }}
                                    />
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 px-4 sm:px-0">
                                {features.map((feature, index) => (
                                    <div
                                        key={index}
                                        className={`group bg-white p-6 md:p-8 rounded-2xl shadow-sm hover:shadow-xl border border-slate-100 hover:border-blue-200 transition-all duration-500 hover:-translate-y-2 cursor-pointer ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
                                        style={{
                                            ...
                                            <div className="flex justify-center mb-4 md:mb-6">
                                                <div className="relative p-3 md:p-4 bg-blue-50 rounded-xl group-hover:bg-blue-100 transition-colors duration-300">
                                                    <img
                                                        src={feature.icon}
                                                        alt={feature.title}
                                                        className="w-10 h-10 md:w-12 md:h-12 opacity-70 group-hover:opacity-100 transition-opacity duration-300"
                                                    />
                                                    {activeCard === index && (
