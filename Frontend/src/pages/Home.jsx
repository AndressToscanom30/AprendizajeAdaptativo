    ...
    return (
        <div className="min-h-screen bg-white relative">
            ...
            <div className="relative z-10">
                <div className="min-h-screen flex items-center py-16 md:py-20 lg:py-0">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                        <div className={`flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16 transition-all duration-1200 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}>
                            <div className="lg:w-1/2 text-center lg:text-left w-full space-y-8">
                                <div>
                                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light mb-6 text-slate-800 leading-tight">
                                        <span className="font-extralight block mb-2">Aprendizaje</span>
                                        <span className="font-bold text-blue-600 relative inline-block">
                                            Adaptativo
                                            <div className="absolute -bottom-3 left-0 w-full h-1 bg-gradient-to-r from-blue-400 to-blue-600 rounded-full transform origin-left scale-x-0 animate-[scaleIn_1.5s_ease-out_1s_forwards]"></div>
                                        </span>
                                    </h1>
                                </div>
                            ...
                            <div className="w-full lg:w-1/2 flex justify-center items-center lg:mt-0">
                                <div className="relative w-full max-w-md lg:max-w-lg aspect-square">
                                    ...
                                    <img
                                        ...
                                        alt="Robot Asistente"
                                        className="relative w-full h-full object-contain transition-all duration-700 hover:scale-105 drop-shadow-2xl"
                                        style={{
                                            transform: `translate(${mousePosition.x * 10}px, ${mousePosition.y * 10}px)`
                                        }}
                                    />

                                    <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-2/3 h-8 bg-blue-200 rounded-full blur-2xl opacity-30"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="py-20 md:py-24 bg-gradient-to-b from-white to-slate-50">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                            {features.map((feature, index) => (
                                <div
                                    key={index}
                                    className={`group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl border border-slate-100 hover:border-blue-200 transition-all duration-500 hover:-translate-y-2 cursor-pointer ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
                                    style={{
                                ...
                                >
                                    <div className="flex flex-col items-center text-center h-full">
                                        <div className="mb-6">
                                            <div className="relative p-4 bg-blue-50 rounded-2xl group-hover:bg-blue-100 transition-colors duration-300">
                                                <img
                                                    src={feature.icon}
                                                    alt={feature.title}
                                                ...
                                                />
                                                {activeCard === index && (
                                                    <div className="absolute -inset-1 bg-blue-200 rounded-2xl -z-10 animate-pulse"></div>
                                                )}
                                            </div>
                                        </div>
                ...
                <div className="py-20 md:py-24 bg-gradient-to-br from-blue-50 via-slate-50 to-blue-50">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
                        <div className="bg-white/90 backdrop-blur-sm p-12 md:p-16 rounded-3xl shadow-2xl border border-white/50">
                            <div className="text-center space-y-8">
                                <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-slate-800 leading-tight">
                                ...
                                <div className="pt-4">
                                    <button
                                        onClick={() => navigate("/diagnostico")}
                                        className="group relative inline-flex px-12 py-5 bg-blue-600 text-white font-medium text-xl rounded-2xl transition-all duration-300 hover:bg-blue-700 hover:shadow-2xl hover:shadow-blue-200 hover:-translate-y-2"
                                    >
